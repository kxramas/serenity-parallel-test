...
public class JbehaveScenario3StoriesRunner extends SerenityStories {

	public JbehaveScenario3StoriesRunner() {
		super();
		findStoriesCalled("stories/bbc/validate_links3.story");
